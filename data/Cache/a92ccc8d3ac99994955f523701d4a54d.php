...
<head>
	<meta charset="utf-8" />
	<title>商家中心-<?php echo ($title); ?>-<?php echo ($name); ?></title>
...
<div class="panel panel-default">
  <div class="panel-body">
     ...
     <div class="row">
	  ...
	  <div class="panel panel-inkfc hidden-xs">
	     ...
	     <div class="panel panel-inkfc">
               <div class="panel-heading"><span class="glyphicon glyphicon-tower"></span>  <b>商家信息</b></div>
                <div class="panel-body">
                <ul class="list-unstyled inleft">
                <?php if(is_array($shopinfo)): $i = 0; $__LIST__ = $shopinfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><img width="160px" class=" hidden-xs" height="140px;" src="<?php echo ($url); echo ($vo["spic"]); ?>"></li>
                <li><h4>商家名称：<?php echo ($vo["sname"]); ?></h4></li>
                <li>人均消费：￥<?php echo ($vo["sprice"]); ?></li>
                <li>订餐电话：<?php echo ($vo["sphone"]); ?></li>
                <li>营业时间：<span class="label label-default" id="dingdan"><?php echo ($vo["opentime"]); ?>:00--<?php echo ($vo["closetime"]); ?>:00</span>
				...
				<span id="s2" style="display:none;"><?php echo ($vo["closetime"]); ?></span>
						...
						<script>
							...
							if(data1<current && current<data2) 
								{
									document.write('<span class="label label-danger">正常营业!</span>');
								}else
								{
									document.write('<span class="label label-success">打烊啦!</span>');
								}

						</script>
					
					</li>
                <li>商家简介：<?php echo ($vo["scontent"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
            	</ul>
                 </div>
         </div>
		  	  ...
		  	  <ul id="breadcrumb">
				  ...
				  <li><a href="<?php echo U('Shop/index/');?>"><span class="icon icon-beaker"> </span> 商家</a></li>
				  <li><a href="#"><span class="icon icon-double-angle-right"></span> 商家中心</a></li>
				</ul>
  <ul class="list-inline inmidd">
   ...
   <div class="clearfix"></div>
	  	  ...
	  	  <div class="col-lg-3 col-md-3 col-xs-12">
		  		 	     <div class="panel panel-inkfc">
               <div class="panel-heading">送餐提示</div>
                <div class="panel-body">
				<p><strong>外卖公告：</strong><?php echo ($notice); ?></p>
				<p><strong>外卖范围：</strong><?php echo ($psarea); ?></p>
				<p><strong>起送金额：</strong><?php echo ($startpay); ?>元</p>
				<p><strong>配送费用：</strong><?php echo ($pspay); ?>元</p>
				<p><strong>店铺地址：</strong><?php echo ($address); ?></p>
                 </div>
         </div>
	      </div><!-- colend-->
	 </div><!-- colend-->
