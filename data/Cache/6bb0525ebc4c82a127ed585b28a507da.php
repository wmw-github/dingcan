...
<head>
	<meta charset="utf-8" />
	<title>商家-<?php echo ($title); ?>-<?php echo ($name); ?></title>
  ...
  <div class="panel-body">
     ...
     <div class="row">
	  ...
	  <div class="panel-heading"><span class="glyphicon glyphicon-shopping-cart"></span>我的菜单</div>
	     ...
	     <div class="panel panel-inkfc hidden-xs">
               <div class="panel-heading"><span class="glyphicon glyphicon-cutlery"></span>  <b>按口味分类</b></div>
                <div class="panel-body">


				<ul class="list-unstyled inleft">
				  <?php if(is_array($foodcatlist)): $i = 0; $__LIST__ = $foodcatlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><li> <a href="<?php echo U('Shop/flist/','id='.$sub['fcid']);?>" class="list-group-item"><span style="margin-left:60px;"><?php echo ($sub["fcname"]); ?></span><span class="fa fa-caret-right pull-right"></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>

				</ul>
				</div>
         </div>
          <div class="panel panel-inkfc hidden-xs">
               <div class="panel-heading"><span class="glyphicon glyphicon-map-marker"></span>  <b>附近商家</b></div>
                <div class="panel-body">

					<ul class="list-unstyled inleft">
					  <?php if(is_array($foodarealist)): $i = 0; $__LIST__ = $foodarealist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><li> <a href="<?php echo U('Shop/farealist/','id='.$sub['a_id']);?>" class="list-group-item"><span style="margin-left:60px;"><?php echo ($sub["a_name"]); ?></span><span class="fa fa-caret-right pull-right"></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
					</ul>
				</div>
         </div>
			  ...
			  <?php if(is_array($shoplist)): $i = 0; $__LIST__ = $shoplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
			     <div class="well col-xs-12" style="padding:3px;margin-bottom:20px;height:168px;width:400px;">
			     <div class="pull-left" style="padding-top:10px;" >
				  ...
				  <img width="120px" class=" visible-xs" src="<?php echo ($url); echo ($vo["spic"]); ?>">
			        ...
			        <div class="pull-left" style="margin-left:20px;padding-top:20px;">
			        <h4>商家：<?php echo ($vo["sname"]); ?></h4>
					<h3  class=" visible-xs pull-left"><?php echo ($vo["sname"]); ?> </h3>
					<p><?php echo ($vo["scontent"]); ?></p>
					<p ><span style="color:#FF7700;font-size:14px"> 人均：￥<?php echo ($vo["sprice"]); ?> </span>
						<p>营业时间：<span class="label label-default"><?php echo ($vo["opentime"]); ?>:00--<?php echo ($vo["closetime"]); ?>:00</span></p>
					<span><a  href="<?php echo U('uc/','id='.$vo['sid']);?>"  class="dingdan btn btn-danger btn-xs ">查看</a> </span>
					</p>
					</div>
