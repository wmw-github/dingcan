...
<ol class="breadcrumb">
  ...
  <?php if(is_array($shoplist)): $i = 0; $__LIST__ = $shoplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php echo U('Shop/farealist/','id='.$vo['sarea']);?>"><?php echo ($aname); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
...
<hr>
     ...
     <div class="row">
			<ul class="nav nav-pills" role="tablist">
				<?php if(is_array($foodcatlist)): $i = 0; $__LIST__ = $foodcatlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><li> <a href="<?php echo U('Shop/flist/','id='.$sub['fcid']);?>"><?php echo ($sub["fcname"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
			</ul>
			<hr>
