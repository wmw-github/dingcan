...
<head>
	<meta charset="utf-8" />
	<title><?php echo ($foodcatname); ?>-商家风味-<?php echo ($title); ?>-<?php echo ($name); ?></title>
...
<ol class="breadcrumb">
  ...
  <li class="active"><?php echo ($foodcatname); ?></li>
</ol>
<hr>
     ...
     <div class="row">
	  <div class="col-lg-3 col-md-3 col-xs-12">
	     ...
	     <div class="panel panel-inkfc hidden-xs">
               <div class="panel-heading"><span class="glyphicon glyphicon-cutlery"></span>  <b>口味分类</b></div>
                <div class="panel-body">
...
<ul class="list-unstyled inleft">
  <?php if(is_array($foodcatlist)): $i = 0; $__LIST__ = $foodcatlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$sub): $mod = ($i % 2 );++$i;?><li> <a href="<?php echo U('Shop/flist/','id='.$sub['fcid']);?>" class="list-group-item"><span style="margin-left:60px;"><?php echo ($sub["fcname"]); ?></span><span class="fa fa-caret-right pull-right"></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
		  	  ...
		  	  <div class="row">
		  	  	<?php if(is_array($shoplist)): $i = 0; $__LIST__ = $shoplist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-lg-4 shop">
