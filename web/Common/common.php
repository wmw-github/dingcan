 ...
 */
 function send_mail($to = '', $subject = '', $body = '', $name = 'test', $attachment = null){
    $from_email = "kuainlp@163.com";
    $from_name = "测试test";
    //$reply_email = '';
    //$reply_name = '';
    //new phpmailer();
    ...
    $mail->Port       = 25;  // SMTP服务器的端口号163为25 gmail为465
    $mail->Username   = "kuainlp@163.com";  // SMTP服务器用户名
    $mail->Password   = "8571o33oo";  // SMTP服务器密码
