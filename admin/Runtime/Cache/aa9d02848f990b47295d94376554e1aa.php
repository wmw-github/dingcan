	  ...
	  <div class="col-lg-12 col-md-12 col-xs-12" style="background-color: #FFF;">
		<!-- begin tab -->
	      <ul class="nav nav-tabs " >
			 ...
			 <li class="active"><a href="<?php echo U('Foodarea/add/');?>" ><b>地区增加</b></a></li>
...
<form class="form-horizontal" role="form"  method="post" action="<?php echo U('Foodarea/addsave/');?>">
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">地区名称</label>
    <div class="col-sm-4">
      <input type="text" class="form-control" id="inputEmail3" name="farea"  placeholder="">
