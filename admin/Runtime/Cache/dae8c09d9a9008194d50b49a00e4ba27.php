...
<form class="form-horizontal" role="form" enctype="multipart/form-data"  method="post" action="__APP__/<?php echo (MODULE_NAME); ?>/editsave">
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">地区名称</label>
    <div class="col-sm-4">
      <input type="text" class="form-control" id="inputEmail3" name="farea" value="<?php echo ($item["farea"]); ?>" placeholder="">

<input type="hidden" name="aid" value="<?php echo ($item["a_id"]); ?>">

    </div>
	<div class="col-sm-6">
<span class="help-block"><i class="fa fa-exclamation"></i> 输入地区名称</span></span>
 </div>
  </div>
