...
<div class="row">
	  ...
	  <div class="col-lg-12 col-md-12 col-xs-12" style="background-color: #FFF;">
       ...
       <li><a href="<?php echo U('Shop/comment/');?>" ><b>商家评论</b></a></li>
              </ul>
		  <p></P>
...
<span class="help-block"><i class="fa fa-exclamation"></i>请输入电话或者手机号</span>
  ...
  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">商家地址</label>
    <div class="col-sm-2">
      <input type="text" class="form-control" name="sdizhi" value="">
   
    </div>
  <div class="col-sm-8">
<span class="help-block"><i class="fa fa-exclamation"></i>商家所在地址</span>
 </div>
  </div>
...
<span class="help-block"></span>
  ...
  <div class="form-group">
	...
	<div class="col-sm-6">
<span class="help-block"><i class="fa fa-exclamation"></i>排序值0-99，值越大越向前，99为推荐</span>
 </div>
  </div> 
