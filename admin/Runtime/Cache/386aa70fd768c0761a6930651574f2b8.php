	  ...
	  <div class="col-lg-10 col-md-10 col-xs-12" style="background-color: #FFF;">
		...
		<!-- begin tab -->
	      <ul class="nav nav-tabs " >
			 ...
			 <li class="active"><a href="<?php echo U('Page/add/');?>" ><b>内容增加</b></a></li>
...
<form class="form-horizontal"role="form" enctype="multipart/form-data" action="__APP__/Page/addsave" method="post">
<div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">标题</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="inputEmail3" name="page_title" value="">
...
<span class="help-block"><i class="fa fa-exclamation"></i>请输入标题,如：关于我们</span>
    ...
    <div class="col-sm-2">
      <input type="text" class="form-control" id="inputEmail3" name="pagedir"  placeholder="">
