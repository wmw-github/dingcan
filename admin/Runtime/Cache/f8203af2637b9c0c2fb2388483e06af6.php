 ...
 <?php if(is_array($pageslist)): $i = 0; $__LIST__ = $pageslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class=""> <a href="<?php echo U('Page/edit/','id='.$vo['pagid']);?>" class="list-group-item"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo ($vo["page_title"]); ?> </a></li><?php endforeach; endif; else: echo "" ;endif; ?>
	  ...
	  <div class="col-lg-10 col-md-10 col-xs-12" style="background-color: #FFF;">
		...
		<!-- begin tab -->
         ...
         <li class="active"><a href="<?php echo U('Link/index/');?>" ><b>友情链接</b></a></li>
			  <li ><a href="<?php echo U('Link/add/');?>" ><b>友情链接增加</b></a></li>
		  ...
		  <p></P>
           ...
           <div class="row"> 
             <div class="col-lg-2 col-md-2 col-xs-2" ><a class="btn blue" href="<?php echo U('Link/add/');?>"> <i class="fa fa-plus"></i>增加链接</a></div>
			    ...
			    <table class="table table-striped table-bordered table-hover ">
									...
									<?php if(is_array($linklist)): $i = 0; $__LIST__ = $linklist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
											...
											<td>
											    ...
											    <a  href="<?php echo U('Link/delete/','id='.$vo['lid']);?>" onClick="delcfm()"><i class="fa fa-trash-o"></i> 删除</a>						
											</td>
