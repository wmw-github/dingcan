		...
		<!-- begin tab -->
          ...
          <li><a href="<?php echo U('Foodcat/index/');?>" ><b>商品分类</b></a></li>
			 ...
			 <li><a href="<?php echo U('Food/add/');?>" ><b>商品增加</b></a></li>
			  <li class="active"><a href="#" ><b>商品修改</b></a></li>
...
<form class="form-horizontal"role="form" enctype="multipart/form-data" action="<?php echo U('Food/editsave/');?>" method="post">

  <div class="form-group">
    <label for="inputEmail3" class="col-sm-2 control-label">商品名称</label>
    <div class="col-sm-4">
      <input type="text" class="form-control" id="inputEmail3" name="fname" value="<?php echo ($item["fname"]); ?>">
	 <input type="hidden"  name="fid" value="<?php echo ($item["fid"]); ?>">
    </div>
	<div class="col-sm-6">
<span class="help-block"><i class="fa fa-exclamation"></i>商品名称，如水煮肉片</span>
 </div>
  </div>
 <div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-2">
      <input type="text" class="form-control" id="inputEmail3" name="fprice" value="<?php echo ($item["fprice"]); ?>">
...
<textarea class="form-control" name="fcontent" rows="3"><?php echo ($item["fcontent"]); ?></textarea>
...
<span class="help-block"></span>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-4">
      <input type="text" class="form-control" id="inputEmail3" name="fsort" value="<?php echo ($item["fsort"]); ?>">
