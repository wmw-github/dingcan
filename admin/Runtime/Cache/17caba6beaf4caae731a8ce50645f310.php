	  ...
	  <div class="col-lg-10 col-md-10 col-xs-12" style="background-color: #FFF;">
		...
		<!-- begin tab -->
		  ...
		  <p></P>
           ...
           <div class="row"> 
             <div class="col-lg-2 col-md-2 col-xs-2" ><a class="btn blue" href="<?php echo U('Articlecate/add/');?>"> <i class="fa fa-plus"></i>增加分类</a></div>
		  ...
		  <p></P>
			    ...
			    <table class="table table-striped table-bordered table-hover ">
									...
									<?php if(is_array($clist)): $i = 0; $__LIST__ = $clist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
											...
											<a  href="<?php echo U('Articlecate/edit/','id='.$vo['acid']);?>"  ><i class="fa fa-edit"></i> 修改</a>
											    <a  href="<?php echo U('Articlecate/delete/','id='.$vo['acid']);?>" onClick="delcfm()"><i class="fa fa-trash-o"></i> 删除</a>
