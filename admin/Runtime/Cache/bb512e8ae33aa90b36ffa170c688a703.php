	  ...
	  <div class="col-lg-12 col-md-12 col-xs-12" style="background-color: #FFF;">
		...
		<!-- begin tab -->
	      <ul class="nav nav-tabs " >
             ...
             <li class="active"><a href="<?php echo U('Food/index/');?>" ><b>商品维护</b></a></li>
		  ...
		  <p></P>
           ...
           <div class="row"> 
             <div class="col-lg-2 col-md-2 col-xs-2" ><a class="btn blue" href="<?php echo U('Food/add/');?>"> <i class="fa fa-plus"></i>增加商品</a></div>
		  ...
		  <p></P>
			      ...
			      <table class="table table-striped table-bordered table-hover">
									...
									<tbody>
									<?php if(is_array($foodlist)): $i = 0; $__LIST__ = $foodlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>

											<td><?php echo ($vo["fname"]); ?></td>
											<td><?php echo ($vo["fprice"]); ?></td>
											<td><?php echo ($vo["fcname"]); ?></td>

											<td><?php echo ($vo["farea"]); ?></td>
											<td><?php echo ($vo["fshop"]); ?></td>
											<td><?php echo ($vo["fsort"]); ?></td>

											<td>
											    
											    <a href="<?php echo U('Food/edit/','id='.$vo['fid']);?>"><i class="fa fa-trash-o"></i> 修改</a>
												<a href="<?php echo U('Food/del/','id='.$vo['fid']);?>"><i class="fa fa-trash-o"></i> 删除</a>
