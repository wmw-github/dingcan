	  ...
	  <div class="col-lg-10 col-md-10 col-xs-12" style="background-color: #FFF;">
		...
		<!-- begin tab -->
	      <ul class="nav nav-tabs " >
             ...
             <li class="active"><a href="<?php echo U('Dbak/import/');?>" ><b>备份列表</b></a></li>
		  ...
		  <p></P>
			    ...
			    <table class="table table-striped table-bordered table-hover ">
									...
									<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
										　　<th><?php echo ($i); ?></th>
											<td><a href="<?php echo ($vo["filename"]); ?>"><?php echo ($vo["filename"]); ?></a></td>
											<td><?php echo ($vo["size"]); ?></td>
											<!-- end <td><?php echo ($vo["dcsort"]); ?></td> 添加 -->
											
										
											<!--<td>
											<a href="<?php echo U('Dbak/restore/'); echo ($vo["filename"]); ?>"><i class="fa fa-edit"></i> 导入</a>
